...
const PLAN_CONFIGS = [
  {
    ...
    price: 98,
    unit: "月",
    usageText: "1500次模型调用/每 5 小时",
    isHighSpeed: true,
    models: ["MiniMax M2.7-highspeed", "MiniMax M2.7", "MiniMax M2.1", "MiniMax M2"],
    modelDescription: "支持最新MiniMax-M2.7-highspeed，约100 TPS 极速推理，同类产品3倍生成速度",
  ...
  },
  {
    ...
    price: 29,
    unit: "月",
    usageText: "600次模型调用/每 5 小时",
    isHighSpeed: false,
    models: ["MiniMax M2.7", "MiniMax M2.1", "MiniMax M2"],
    modelDescription: "支持最新 MiniMax M2.7，正常约50TPS，低峰时段100TPS",
